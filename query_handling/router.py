...
from ragi_types import QueryType
from config import config
# Topic extraction removed - semantic search handles topic matching
...
class QueryRouter:
    ...
    def __init__(self, conversation_handler, retrieval_handler, command_handler, memory=None):
        ...
        # Language detection removed - assuming English queries
        # Topic extraction removed - semantic search handles topics
    ...
    def route_query(self, query_analysis: Dict[str, Any], stream=False) -> Tuple[Any, bool]:
        ...
        # Language detection removed - system assumes English queries
        
        # Ambiguity detection removed - LLM handles unclear queries naturally
        ...
        for pattern_group in boundary_patterns:
            if any(pattern in query_lower for pattern in pattern_group):
                ...
                if any(time_word in pattern_group for time_word in ['time', 'current time', 'what time', 'clock']):
                    # Check if this is a generic time query vs domain-specific time query
                    if self._is_generic_time_query(query_lower):
                        logger.debug(f"Matched generic time boundary pattern: {pattern_group}")
                        return True
                    else:
                        logger.debug(f"Time query appears domain-specific, allowing through: {query}")
                        continue
    ...
    def _is_generic_time_query(self, query_lower: str) -> bool:
        """
        Determine if a time-related query is generic (current time) vs domain-specific (schedules).
        
        Args:
            query_lower: Lowercase query string
            
        Returns:
            True if generic time query, False if domain-specific time query
        """
        # domain-specific time keywords
        apu_time_keywords = [
        ...
        # If the query contains context-specific keywords, it's NOT a generic time query
        ...
        # If it matches generic patterns without specific context, it's generic
        ...
        # Default: if it contains time but has other context, probably context-specific
        return False
    ...
    def _handle_boundary_query(self, query: str, stream=False) -> Union[str, Iterator[str]]:
        ...
        if any(word in query_lower for word in ['weather', 'temperature', 'climate', 'rain', 'sunny', 'hot', 'cold']):
            response = (
                ...
                "Is there anything about available services or procedures I can help you with instead?"
            )
            ...
            response = (
                ...
                "However, I can help you with calendars, schedules, and important dates. "
                "What date information from the knowledge base do you need?"
            )
            ...
            response = (
                "I don't provide political opinions or information. I'm designed to help with knowledge base topics. "
                "For political information, please check reputable news sources. "
                "How can I help you with available services or information instead?"
            )
            ...
            response = (
                ...
                "I can help you with official communication channels and announcements though!"
            )
            ...
            response = (
                ...
                "I'm here to help with information and services from the knowledge base. "
                "What can I help you with?"
            )
        elif any(word in query_lower for word in ['fun', 'hobby', 'family', 'friends', 'relationship']):
            response = (
                "I don't have personal experiences, but I can help you with information from the knowledge base! "
                "I can provide details about activities, facilities, and services. "
        ...
        # Note: Removed library hours handling as this info exists in knowledge base
            ...
            response = (
                ...
                "For information about housing and accommodation, please contact the appropriate department."
            )
            ...
            response = (
                ...
                "I can help you with events, facilities, and activities from the knowledge base instead!"
            )
            ...
            response = (
                ...
                "I can help you with dining facilities and cafeteria information from the knowledge base though!"
            )
        else:
            response = (
                "I don't have specific information about that topic in my knowledge base. "
                "For accurate and detailed information, I recommend contacting the appropriate department."
            )
    ...
    def _is_conversational_query(self, query: str) -> bool:
        ...
        conversational_patterns = [
            ...
            # System knowledge/capabilities (only without "about" following)
    ...
    def _handle_identity_query(self, query: str, stream=False) -> Union[str, Iterator[str]]:
        ...
        if is_return_user:
            response = """Since we've chatted before, you know I'm RAGI - your intelligent knowledge assistant!
...
I use the official knowledge base to provide accurate, up-to-date information. What specific topic can I help you explore?"""
        else:
            response = """Hello! I'm RAGI, your intelligent knowledge assistant.

🎓 **My Purpose:** I'm designed to help users find information about available services, procedures, and policies.
...
🔍 **How I Work:** I use the official knowledge base to provide accurate information, so you can trust that what I tell you is current and official.

**Ready to help!** What would you like to know from the knowledge base?"""
...
What would you like to know from the knowledge base?"""
    ...
    def _extract_recent_topics(self) -> str:
        ...
        # Common topic keywords to identify
        topic_keywords = {
        ...
        return "topics from the knowledge base"
    
    def _handle_empty_query(self, stream=False) -> Union[str, Iterator[str]]:
        """Handle empty or whitespace-only queries."""
        response = (
            "I'd be happy to help! Please ask me a question about available services, "
    ...
    def _handle_long_query(self, query: str, stream=False) -> Union[str, Iterator[str]]:
        ...
        # Topic extraction removed - let LLM handle complex queries directly
        key_topics = []
    ...
    def _handle_system_error(self, stream=False) -> Union[str, Iterator[str]]:
        ...
        response = (
            ...
            "Please try asking your question again, or contact support directly if the "
            "problem persists."
        )
    ...
    def _handle_inappropriate_request(self, query: str, stream=False) -> Union[str, Iterator[str]]:
        ...
        response = (
            ...
            "Instead, I'd be happy to help you with legitimate available services such as:\n\n"
            "• Academic support and study resources\n"
            "• Assignment submission procedures\n"
            "• Academic policies and guidelines\n"
            "• Student support services\n"
            "• IT help and technical support\n\n"
            "Is there something specific about available services I can help you with?"
        )
