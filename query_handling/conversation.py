...
class ConversationHandler:
    ...
    def __init__(self, memory, stream_delay=None):
        ...
        self.greeting_responses = [
            "Hey there! I'm doing great, thanks for asking! 😊 I'm RAGI, ready to help you with information from the knowledge base. What's on your mind?",
            "Hi! I'm fantastic today - hope you are too! ☀️ I'm RAGI, what can I help you find out about the knowledge base?",
            "Hello! I'm doing well, thank you! A bit busy helping users but I love it! 😄 I'm RAGI, how can I assist you today?",
            "Hey! I'm good, thanks for asking! The weather's been nice lately. 🌤️ I'm RAGI, what questions do you have for me?",
            "Hi there! I'm doing awesome, thanks! Ready to dive into some information with you. What would you like to know?",
            "Hello! I'm great, thank you for asking! 😊 I'm RAGI, always excited to help with your questions. What brings you here today?",
            "Hey! I'm doing wonderful, thanks! Hope your day is going well too! I'm RAGI, what can I help you with?"
        ]
        ...
        self.knowledge_responses = [
            "I'm RAGI, your knowledge assistant! 😊 I can help with various topics, procedures, services, and information. What would you like to know about the knowledge base?",

            "Hey! I'm RAGI, here to help with your questions! 😄 I know about procedures, applications, services, and more. What can I help you with?",

            "I'm RAGI! 🌟 I can assist with services, information, and procedures. What topic interests you?",
        ]
        ...
        self.farewell_responses = [
            "Goodbye! Have a wonderful day ahead! 🌈 Feel free to come back anytime if you need information!",
            "Take care! 👋 Remember, I'm RAGI, always here whenever you need help!",
            "Bye for now! 😊 Don't hesitate to return if you have any questions later!",
            "See you later! 👋 I'll be here whenever you need information or guidance!",
            "Farewell! 🌟 Hope I was able to help today. Come back anytime for assistance!",
            "Have a great day! 😊 Thanks for chatting - I'm here whenever you need support!",
            "Until next time! 👋 Feel free to return with any questions you might have!",
        ...
        self.small_talk_responses = [
            "My day's been great, thanks for asking! 😊 Helping users like you makes it even better. I'm RAGI, what can I do for you?",
            "Nice to meet you too! 🤝 I'm RAGI, excited to help you. What would you like to know?",
            "Aw, thanks! 😄 I hope you're having a wonderful day too. I'm RAGI, what info can I dig up for you?",
            "It's been a good day! Always enjoy chatting about the knowledge base. 🌟 I'm RAGI, what brings you here today?",
            "Everything's going smoothly on my end! ✨ I'm RAGI, ready and eager to help with your questions. What's up?",
            "Thank you! I hope you have an amazing day too! 🌈 I'm RAGI, what can I help you with?",
        ]
        ...
        self.acknowledgement_responses = [
            ...
            "My pleasure! 😄 I'm RAGI, and I love helping. Anything else on your mind?",
            "Glad I could help out! ✨ Feel free to ask if you need anything else!",
            "Awesome! 🙌 You're all set then! Come back anytime if you need more information!",
            ...
            "Yes! 🌟 So happy that hit the spot! I'm RAGI, here if you need more assistance!"
        ]
        ...
        self.naming_responses = [
            "You can call me RAGI! 😊 I'm your friendly knowledge assistant, here to help with any questions. What can I help you with today?",
            "I'm RAGI! 🌟 Feel free to call me RAGI - I'm your go-to assistant for information from the knowledge base. What would you like to know?",
            "Just call me RAGI! 😄 I'm here to help you navigate information and services. What brings you here today?",
            "You can call me RAGI! 👋 I'm your knowledge assistant, ready to help with any questions. How can I assist you?",
            "I'm RAGI! 😊 That's what everyone calls me. I'm here to help with questions and information. What can I help you explore?",
        ]
    ...
    def handle_conversation(self, query: str, stream=False):
        ...
        if greeting_match:
            ...
            if is_return_user:
                ...
                contextual_greetings = [
                    ...
                    "Hi there! 👋 Welcome back! I'm having a wonderful day helping users. What information do you need?",
                    "Hello! 🌟 Nice to chat with you again! I'm doing fantastic. What would you like to explore about the knowledge base today?",
                    "Hey! 😄 Great to see you return! I'm doing awesome, hope you are too! How can I help you?"
                ]
        ...
        # Check for acknowledgements
            ...
            if is_return_user and len(self.memory.chat_memory.messages) > 2:
                contextual_acknowledgements = [
                    "You're very welcome! 😊 I absolutely love helping with questions! Anything else you'd like to explore?",
                    "My pleasure! 🎉 I'm so glad I could help clear things up about the knowledge base. What else can I assist with?",
                    "Happy to help! 😄 That's what makes my day! Feel free to ask about anything else from the knowledge base!",
                    "You're welcome! ✨ I'm here whenever you need more information or guidance!"
                ]
        ...
        # Check for clarification requests
            ...
            if is_return_user:
                ...
                if recent_topics:
                    response = f"No worries! 😊 I see we were talking about {recent_topics}. Would you like me to explain that better, or is there something else about the knowledge base you'd like to understand?"
                else:
        ...
        # Check for farewells LAST (to avoid catching other patterns accidentally)
            ...
            if is_return_user:
                ...
                contextual_farewells = [
                    "Goodbye! 👋 It was great chatting with you again. Feel free to return anytime for help!",
                    "Take care! 😊 Thanks for the conversation - I'm always here when you need assistance!",
                    "See you later! 🌟 I enjoyed helping you today. Come back whenever you have questions!",
                    "Farewell! 💫 Hope our chat was helpful. Don't hesitate to return for more information!"
                ]
        ...
        if not response:
            ...
            if is_return_user:
                response = "I'm here and ready to help! 😊 What questions are on your mind today?"
            else:
                response = "Hi there! 👋 I'm here to help you with information from the knowledge base. What would you like to know?"
