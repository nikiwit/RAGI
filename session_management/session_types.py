...
class ChatSession:
    ...
    def __init__(self, session_id: str, title: str = None):
        ...
        system_message = SystemMessage(
            content="I am RAGI, a Retrieval-Augmented Generation assistant. I help answer questions based on your document collection using semantic search and AI-powered response generation."
        )
