"""
Main RAGI application class with production model management.

This module provides the primary interface for the RAGI system, including:
...
class RAGI:
    """
    Main RAGI application class for command line interface with production features.

    This class orchestrates all components of the RAGI system including document processing,
    ...
    def run_cli(self):
        ...
        print("\n" + "="*60)
        print("RAGI - Your Knowledge Assistant")
        print("="*60)
        print("Ask questions using natural language. I'm RAGI, your friendly assistant.")
        print("Commands:")
        ...
        while True:
            try:
                ...
                if not query:
                    print("I'd be happy to help! Please ask me a question, such as:")
                    print("• General information")
                    print("• Support and assistance")
                    print("• Technical documentation")
                    print("• Account and settings")
                    print("• How-to guides")
                    continue
