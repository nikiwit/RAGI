...
class KnowledgeBaseTextSplitter:
    """Custom text splitter for knowledge base content."""
    ...
    def split_documents(self, documents: List[Document]) -> List[Document]:
        """Split knowledge base documents into contextual chunks with headers."""
        result_docs = []
        total_docs = len(documents)

        logger.info(f"KnowledgeBaseTextSplitter processing {total_docs} documents")
        ...
        for i, doc in enumerate(documents):
            ...
            # Most knowledge base documents are small FAQs - if they're under chunk size, keep them intact
        ...
        logger.info(f"KnowledgeBaseTextSplitter finished processing {len(result_docs)} documents")
        return result_docs
