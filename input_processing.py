...
class InputProcessor:
    ...
    def analyze_query(self, query: str, conversation_context: str = None) -> Dict[str, Any]:
        ...
        Returns:
            ...
            - extracted_terms: Education/domain-specific terms extracted
        ...
        # Extract education/domain-specific terms
        edu_terms = self._extract_education_terms(normalized_query, tokens)
        
        # Identify query type (enhanced with domain-specific types)
    ...
    def _extract_education_terms(self, query: str, tokens: List[str]) -> List[str]:
        """
        Extract education and domain-specific terms from the query.
        ...
        Returns:
            List of education/domain-specific terms
        """
        edu_terms = []
        ...
        # Check for course codes (e.g., COURSE1F2103)
    ...
    def classify_query_type(self, query: str, tokens: List[str], edu_terms: List[str]) -> QueryType:
        """
        Classify the query into different types, including domain-specific types.
        """
        ...
        # Check for domain-specific academic queries
        academic_patterns = [
        ...
        # Check for domain-specific administrative queries
        ...
        # Check for domain-specific financial queries
        financial_patterns = [
        ...
        # Fall back to standard query classification if no domain-specific match
    ...
    def expand_query(self, query: str, keywords: List[str]) -> List[str]:
        """
        Expand the query with synonyms, semantic variations, and domain-specific terms.
    ...
    def _extract_context_entities(self, context: str) -> List[str]:
        ...
        # domain-specific entities to look for
        apu_entities = {
            # Academic entities
